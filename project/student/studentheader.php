...
<body class="bg-gray-100 flex">
    ...
    <aside class="relative h-screen w-72 hidden sm:block bg-gray-50 shadow-lg">
        <div class="p-6 flex">
            ...
            <!--<a href="studentdashboard.php" class="font-semibold text-3xl text-indigo-500 tracking-wide px-3 py-2"><?php echo $row1['college_name']; ?></a>-->
            
        </div>
        <nav class="text-white font-semibold pt-3 p-4">
            <a href="studentdashboard.php" class="flex items-center text-gray-700  mt-4 py-2 px-5 bg-indigo-100 rounded-md hover:shadow-md transition duration-200">
                <i class="fas fa-tachometer-alt mr-3"></i>
                DASHBOARD
            </a>
            <a href="subject.php" class="flex items-center text-gray-700  mt-4 py-2 px-5 hover:bg-indigo-100 rounded-md hover:shadow-md transition duration-200">
            ...
            <!--    QUIZ-->
            <!--</a>-->
            <!--<a href="viewleaderboard.php" class="flex items-center text-gray-700  mt-4 py-2 px-5 hover:bg-indigo-100 rounded-md hover:shadow-md transition duration-200">-->
            <!--    <i class="fa fa-bell mr-3"></i>-->
            <!--    LEADERBOARD-->
            <!--</a>-->
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header x-data="{ isOpen: false }" class="w-full py-5 px-6 sm:hidden bg-indigo-500">
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                ...
                <a href="subject.php" class="flex items-center text-white px-5 py-2 hover:bg-indigo-50 hover:text-indigo-600 rounded-md hover:shadow-md transition duration-200">
                    <i class="fa fa-user mr-3"></i>
                    SUBJECTS
                </a>
                ...
                <a href="viewleaderboard.php" class="flex items-center text-white px-5 py-2 hover:bg-indigo-50 hover:text-indigo-600 rounded-md hover:shadow-md transition duration-200">
                    <i class="fa fa-bell mr-3"></i>
                    LEADERBOARD
                </a>
