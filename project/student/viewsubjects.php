...
$res= mysqli_query($conn,"SELECT `sumap_id`,tbl_program.program_name,tbl_program.year_id,tbl_specialization.specialization_name,subjects_mapping.semester_id,tbl_subject.subject_name,tbl_subject.subject_code,tbl_subject.subject_credits,tbl_user.fullname FROM subjects_mapping,tbl_program,tbl_specialization,tbl_subject,tbl_user WHERE subjects_mapping.program_id=tbl_program.program_id AND subjects_mapping.specialization_id=tbl_specialization.specialization_id AND subjects_mapping.subject_id=tbl_subject.subject_id AND subjects_mapping.users_id=tbl_user.users_id AND subjects_mapping.program_id=$program_id AND subjects_mapping.specialization_id=$specialization_id AND subjects_mapping.semester_id=$semester_id");
  ...
  <div class="container">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo $row['subject_credits']?></td>
