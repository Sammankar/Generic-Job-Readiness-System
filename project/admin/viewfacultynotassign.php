            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="flex flex-wrap lg:flex-row overflow-auto">
                    ...
                    ?>
                                ...
                                <p class="text-sm font-medium uppercase text-gray-700">Total Subject Mapped</p>
                                </div>
                            </div>

                            <div class="mt-8 inline-flex items-center gap-2 text-indigo-600 sm:mt-10 lg:mt-14">
                                <p class="font-medium sm:text-lg">Subject Map</p>
                ...
                <div class="bg-white overflow-auto mt-4 mr-2 ml-2 lg:ml-0">
                 ...
                 <h1 class="mt-4 text-indigo-500 ml-2 text-2xl"><i class="fa fa-list text-indigo-500 mr-2"></i>Subject Map List</h1>
                    <table class="w-full leading-normal">
                            <tbody class>
                                <tr class="table-row">
                                    <?php
                                        include('viewfacultynotassigndash.php');
                                    ?>
                                </tr>
                            </tbody>
                        </table>
