                ...
                <div class="flex flex-wrap lg:flex-row overflow-auto">
                    <div class="w-full lg:w-1/4 pr-0 lg:pr-2 rounded-md m-2 lg:m-0 lg:mt-2">
                       ...
                       $tat = "SELECT * FROM `tbl_user` WHERE `username`='$username'";
                        ...
                        $query = "SELECT specialization_id FROM tbl_specialization WHERE college_id='$college_id' ORDER BY specialization_id";  
                    ...
                    ?>
                                ...
                                <p class="text-sm font-medium uppercase text-gray-700">Total Specialization</p>
                                </div>
                            </div>
                 ...
                 <div class="mt-6 text-align-right ">
                    ...
                    <table class="w-full leading-normal">
                            <tbody class>
                                <tr class="table-row">
                                    <?php
                                        include('specializationdash.php');
                                    ?>
                                </tr>
                            </tbody>
                        </table>
