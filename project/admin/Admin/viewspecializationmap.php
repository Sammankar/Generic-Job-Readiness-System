            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="flex flex-wrap lg:flex-row overflow-auto">
                    <div class="w-full lg:w-1/4 pr-0 lg:pr-2 rounded-md m-2 lg:m-0 lg:mt-2">
                       ...
                       $tat = "SELECT * FROM `tbl_user` WHERE `username`='$username'";
                        ...
                        if($tresult1)
                        {
                         ...
                         $query = "SELECT smap_id FROM specializations_mapping WHERE college_id='$college_id' ORDER BY smap_id";  
                    ...
                    ?>
                                ...
                                <p class="text-sm font-medium uppercase text-gray-700">Total Map Specialization</p>
                                </div>
                            </div>

                            <div class="mt-8 inline-flex items-center gap-2 text-indigo-600 sm:mt-10 lg:mt-14">
                                <p class="font-medium sm:text-lg">Specializations</p>
                ...
                <div class="bg-white overflow-auto mt-4 mr-2 ml-2 lg:ml-0">
                 ...
                 <h1 class="mt-4 text-indigo-500 ml-2 text-2xl"><i class="fa fa-list text-indigo-500 mr-2"></i>Specializations Map List</h1>
                 <div class="mt-6 text-align-right ">
                    <button onclick="window.location.href = 'specializationmap.php';" class="text-align-right cursor display-inline-block cursor-pointer relative justify-center rounded-md bg-indigo-600 py-1 px-3 text-md font-semibold text-white hover:bg-indigo-500 transition duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                		<b>+ MAP Specialization</b>
                	</button>
                  </div>
                    <table class="w-full leading-normal">
                            <tbody class>
                                <tr class="table-row">
                                    <?php
                                        include('specializationmapdash.php');
                                    ?>
                                </tr>
                            </tbody>
                        </table>
