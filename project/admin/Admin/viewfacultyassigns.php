        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                <div class="flex flex-wrap lg:flex-row overflow-auto">
                    <div class="w-full lg:w-1/4 pr-0 lg:pr-2 rounded-md m-2 lg:m-0 lg:mt-2">
                       ...
                       $tat = "SELECT * FROM `tbl_user` WHERE `username`='$username'";
                        ...
                        $query = "SELECT `sumap_id` FROM `subjects_mapping` WHERE `college_id`='$college_id' AND assign_status=1 ORDER BY `sumap_id`";  
                    ...
                    ?>
                                ...
                                <p class="text-sm font-medium uppercase text-gray-700">Total Faculty Mapped</p>
                                </div>
                            </div>

                            <div class="mt-8 inline-flex items-center gap-2 text-indigo-600 sm:mt-10 lg:mt-14">
                                <p class="font-medium sm:text-lg">Faculty Map</p>
                ...
                <div class="bg-white overflow-auto mt-4 mr-2 ml-2 lg:ml-0">
                 ...
                 <h1 class="mt-4 text-indigo-500 ml-2 text-2xl"><i class="fa fa-list text-indigo-500 mr-2"></i>Faculty Map List</h1>
                    <table class="w-full leading-normal">
                            <tbody class>
                                <tr class="table-row">
                                    <?php
                                        include('viewfacultyassigndash.php');
                                    ?>
                                </tr>
                            </tbody>
                        </table>
