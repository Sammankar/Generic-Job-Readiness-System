        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
               ...
               <?php
                        ...
                        $query = "SELECT `sm_id`, `users_id`, `college_id`, `program_id`, `specialization_id`, `semester_id`, `studentmap_status` FROM `student_mapping` WHERE college_id=$college_id ORDER BY sm_id";  
                    ...
                    ?>
                                ...
                                <p class="text-sm font-medium uppercase text-gray-700">Total Students Map</p>
                                </div>
                            </div>

                            <div class="mt-8 inline-flex items-center gap-2 text-indigo-600 sm:mt-10 lg:mt-14">
                                <p class="font-medium sm:text-lg">Students Map</p>
