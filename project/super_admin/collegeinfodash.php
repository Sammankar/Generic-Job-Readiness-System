  ...
  <div class="container" style="margin-top:50px;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="viewcollege.php?college_id=<?php echo $row['college_id']?>"><i class="far fa-pen" data-toggle="tooltip" title="View"></i></a>
          <a href="editcollegedetails.php?college_id=<?php echo $row['college_id']?>"><i class="far fa-pen" data-toggle="tooltip" title="edit"></i></a>
                </td>
