...
?>
    <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <h1 class="text-xl mt-4 text-indigo-500 pb-4 ml-2"><i class="fa fa-list text-indigo-500 mr-2"></i>Activity</h1>
                    ...
                    <div class="w-full lg:w-1/4 pr-0 lg:pr-2 rounded-md m-2 lg:m-0 lg:mt-2">
                        <a href="#" class="group flex flex-col justify-between rounded-sm bg-white p-4 shadow-md transition-shadow hover:shadow-lg sm:p-6 lg:p-8">
                            <div>
                                ...
                                <p class="text-sm font-medium uppercase text-gray-700">Total Universities</p>
                                </div>
                            </div>

                            <div class="mt-8 inline-flex items-center gap-2 text-indigo-600 sm:mt-10 lg:mt-14">
                                <p class="font-medium sm:text-lg">View all Universities</p>
                ...
                <div class="bg-white overflow-auto mt-4 mr-2 ml-2 lg:ml-0">
                    <h1 class="mt-4 text-indigo-500 pb-4 ml-2 text-2xl"><i class="fa fa-list text-indigo-500 mr-2"></i>Universities List</h1>
                        <table class="w-full leading-normal">
                            <tbody class>
                            <tr class="table-row">
                                <?php
                                    include('allcollegesdash.php');
                                ?>
                            </tr>
                        </tbody>
                        </table>
