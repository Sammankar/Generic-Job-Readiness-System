...
<body class="bg-gray-100 flex">
    ...
    <aside class="relative h-screen w-72 hidden sm:block bg-gray-50 shadow-lg">
        <div class="pt-3 pl-3">
            <img src="../images/logo.png" style="margin-left: 60px;" height="70px" width="70px">
            <a href="#" class="font-semibold text-2xl text-indigo-500 tracking-wide px-3 py-2 pl-6">SUPER-ADMIN</a>
        </div>
        <nav class="text-white font-semibold pt-1 pl-4 pw-4">
            <a href="dashboard.php" class="flex items-center text-gray-700  mt-4 py-2 px-5 bg-indigo-100 rounded-md hover:shadow-md transition duration-200">
                <i class="fas fa-tachometer-alt mr-3"></i>
                DASHBOARD
            </a>
            <a href="addadmin.php" class="flex items-center text-gray-700  mt-4 py-2 px-5 hover:bg-indigo-100 rounded-md hover:shadow-md transition duration-200">
                <i class="fa fa-user mr-3"></i>
                ADD ADMIN
            </a>
            <a href="allcolleges.php" class="flex items-center text-gray-700  mt-4 py-2 px-5 hover:bg-indigo-100 rounded-md hover:shadow-md transition duration-200">
