            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="flex flex-wrap lg:flex-row overflow-auto">
                    <div class="w-full lg:w-1/4 pr-0 lg:pr-2 rounded-md m-2 lg:m-0 lg:mt-2">
                        <a href="viewallstudymaterial.php" class="group flex flex-col justify-between rounded-sm bg-white p-4 shadow-md transition-shadow hover:shadow-lg sm:p-6 lg:p-8">
                            <div>
                                  <?php
                       ...
                       $tat = "SELECT * FROM `tbl_user` WHERE `username`='$username'";
                        ...
                        if($tresult1)
                        {
                         ...
                         else
                         {
                            ...
                            $sql1 = "SELECT * FROM `subjects_mapping` WHERE `users_id`=$tusers_id";
                        ...
                        $query = "SELECT `studymaterial_id` FROM `tbl_studymaterial` WHERE college_id='$college_id' AND users_id='$tusers_id' ORDER BY studymaterial_id";  
                    ...
                    ?>
                                ...
                                <p class="text-sm font-medium uppercase text-gray-700">Total Study-Materials</p>
                                </div>
                            </div>

                            <div class="mt-8 inline-flex items-center gap-2 text-indigo-600 sm:mt-10 lg:mt-14">
                                <p class="font-medium sm:text-lg">View All Study Materials</p>
                ...
                <div class="bg-white overflow-auto mt-4 mr-2 ml-2 lg:ml-0">
                 ...
                 <h1 class="mt-4 text-indigo-500 ml-2 text-2xl"><i class="fa fa-list text-indigo-500 mr-2"></i>Uploaded Study-Material List</h1>
                    <table class="w-full leading-normal">
                            <tbody class>
                                <tr class="table-row">
                                    <?php
                                        include('allstudymaterialdash.php');
                                    ?>
                                </tr>
                            </tbody>
                        </table>
