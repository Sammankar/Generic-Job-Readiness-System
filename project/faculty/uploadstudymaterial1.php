...
$doc_ex_to_lc = strtolower($doc_ex);
        $allowed_exs = array('mov','mp4','3gp','ogg');
        $t=time();
        if(in_array($doc_ex_to_lc, $allowed_exs)){
              $new_doc_name = $t.'.'.$doc_ex_to_lc;
              $doc_upload_path = '../images/studymaterialv/'.$new_doc_name;
              move_uploaded_file($tmp_name, $doc_upload_path);
        
        $users_id=$tusers_id;
 $sql2="INSERT INTO `tbl_studymaterial`(`studymaterial_id`, `college_id`, `users_id`, `program_id`, `specialization_id`, `semester_id`, `subject_id`, `document_id`, `topic_name`, `file`, `upload_time`) VALUES (NULL,'$college_id','$users_id','$program_id','$specialization_id','$semester_id','$subject_id','2','$topic_name','$new_doc_name',CURRENT_TIMESTAMP)";
            ...
            <div class="w-4/6 mt-6 pl-0 lg:pl-2">
                        <div class="leading-loose">
                            <form class="p-10 bg-white rounded-md shadow-md" method="post" enctype="multipart/form-data">
                                <p class="text-xl text-gray-800 font-medium pb-4">Upload Study Material(Video)</p>
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="mt-4">
                                    <label class="block text-sm text-gray-600">To Upload Video...</label>
