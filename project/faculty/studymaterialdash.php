    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="flex">
                    ...
                    <p><a href="uploadstudymaterial.php?sumap_id=<?php echo $row['sumap_id']?>"  class="btn btn-outline-primary" data-toggle="tooltip" title="Document Upload">Document</a></p>
                    <p><a href="uploadstudymaterial1.php?sumap_id=<?php echo $row['sumap_id']?>"  class="btn btn-outline-info" data-toggle="tooltip" title="VIdeo Upload">Video</a></p>
